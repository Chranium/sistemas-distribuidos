...
// extern void  timing(int id_station);
extern void timing(int id_transfer, int id_station);
// extern void  event_schedule(float time_of_event, int type_of_event);
// extern void  event_schedule(int id_station, float time_of_event, int type_of_event);
extern void event_schedule(int id_transfer, int id_station, float time_of_event, int type_of_event);
